// Default, opinionated weights tuned to your behavior.
...
export const VERDICT_THRESHOLDS = {
  ...
  // Shopping (behavior-tuned + itemCount-aware)
  export const SHOPPING_DEFAULTS = {
    // CARRY effort tiering (super-linear past 30/60)
    tier1Limit: 30,
    tier2Limit: 60,
    tier1Cost: 0.09,  // eq-mi per unit (0–30)
    tier2Cost: 0.22,  // eq-mi per unit (31–60)
    tier3Cost: 0.50,  // eq-mi per unit (61+)
  
    // PATH effort per DISTINCT item (SKU)
    itemPathCost: 0.15, // eq-mi per unique SKU
